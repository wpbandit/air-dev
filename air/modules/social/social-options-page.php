...
//! Set option name
$option = air_social::get_var('option_name');
...
<div id="air-social" class="air-module-container">
	...
	<?php $items = air_social::get_items(); ?>
		<div>
			...
			<?php settings_fields($option.'-settings'); ?>
			<table class="air-social-table" cellpadding="0" cellspacing="0">
				<thead>
					<tr>
				...
				<tbody class="sortable">
					...
					<tr>
						...
						<td class="link">
							<input name="<?php echo $option.'['.$key.']'; ?>[url]" type="text" class="code" value="<?php echo $item['url']; ?>">
						</td>
						<td class="title">
